<nav class="navbar navbar-expand-lg navbar-dark bg-custome navbar-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link"><i class="fa fa-plus-square" aria-hidden="true"></i>Add Notes</a>
      </li>
     
      <li class="nav-item">
        <a class="nav-link"><i class="fa fa-address-book-o" aria-hidden="true"></i>Show Notes</a>
      </li>
    </ul>
